...
IMAGE_GENERATE_SCHEMA = {
    "name": "image_generate",
    "description": "Genera imágenes de alta calidad a partir de prompts de texto usando el modelo FLUX 2 Pro con ampliación automática 2x. Crea imágenes detalladas y artísticas que se amplían automáticamente para resultados de alta resolución. Devuelve una URL de imagen ampliada. Muéstrala usando markdown: ![description](URL)",
    "parameters": {
        "type": "object",
        "properties": {
            "prompt": {
                "type": "string",
                "description": "El prompt de texto que describe la imagen deseada. Sé detallado y descriptivo."
            },
            "aspect_ratio": {
                "type": "string",
                "enum": ["landscape", "square", "portrait"],
                "description": "La relación de aspecto de la imagen generada. 'landscape' es 16:9 ancho, 'portrait' es 16:9 alto, 'square' es 1:1.",
                "default": "landscape"
            }
        },
        "required": ["prompt"]
