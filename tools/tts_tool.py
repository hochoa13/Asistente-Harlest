...
TTS_SCHEMA = {
    "name": "text_to_speech",
    "description": "Convierte texto a audio de voz. Devuelve una ruta MEDIA: que la plataforma entrega como mensaje de voz. En Telegram se reproduce como burbuja de voz, en Discord/WhatsApp como archivo de audio adjunto. En modo CLI, guarda en ~/voice-memos/. La voz y el proveedor están configurados por el usuario, no seleccionados por el modelo.",
    "parameters": {
        "type": "object",
        "properties": {
            "text": {
                "type": "string",
                "description": "El texto a convertir a voz. Mantén bajo 4000 caracteres."
            },
            "output_path": {
                "type": "string",
                "description": "Ruta de archivo personalizada opcional para guardar el audio. Por defecto ~/.hermes/audio_cache/<timestamp>.mp3"
            }
        },
        "required": ["text"]
    }
