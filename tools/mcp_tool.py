    ...
    return [
        {
            "schema": {
                ...
                "description": f"Lista recursos disponibles del servidor MCP '{server_name}'",
                "parameters": {
                    "type": "object",
                    "properties": {},
                },
        ...
        },
        {
            "schema": {
                ...
                "description": f"Lee un recurso por URI del servidor MCP '{server_name}'",
                "parameters": {
                    "type": "object",
                    "properties": {
                        "uri": {
        ...
        },
        {
            "schema": {
                ...
                "description": f"Lista prompts disponibles del servidor MCP '{server_name}'",
                "parameters": {
                    "type": "object",
                    "properties": {},
                },
        ...
        },
        {
            "schema": {
                ...
                "description": f"Obtiene un prompt por nombre del servidor MCP '{server_name}'",
                "parameters": {
                    "type": "object",
                    "properties": {
                        "name": {
                            "type": "string",
                            "description": "Nombre del prompt a recuperar",
                        },
                        "arguments": {
                            "type": "object",
                            "description": "Argumentos opcionales para pasar al prompt",
                        },
                    },
                    "required": ["name"],
                },
