...
MOA_SCHEMA = {
    ...
    "description": "Enruta un problema difícil a través de múltiples LLMs de frontera de manera colaborativa. Realiza 5 llamadas a API (4 modelos de referencia + 1 agregador) con esfuerzo máximo de razonamiento — úsalo con moderación para problemas genuinamente difíciles. Mejor para: matemáticas complejas, algoritmos avanzados, razonamiento analítico multi-paso, problemas que se benefician de perspectivas diversas.",
    "parameters": {
        "type": "object",
        "properties": {
            "user_prompt": {
                "type": "string",
                "description": "La consulta compleja o problema a resolver usando múltiples modelos de IA. Debe ser un problema desafiante que se beneficie de perspectivas diversas y razonamiento colaborativo."
            }
        },
