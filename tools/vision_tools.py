...
VISION_ANALYZE_SCHEMA = {
    "name": "vision_analyze",
    "description": "Analiza imágenes usando visión por IA. Proporciona una descripción completa y responde una pregunta específica sobre el contenido de la imagen.",
    "parameters": {
        "type": "object",
        "properties": {
            "image_url": {
                "type": "string",
                "description": "URL de imagen (http/https) o ruta de archivo local a analizar."
            },
            "question": {
                "type": "string",
                "description": "Tu pregunta o solicitud específica sobre la imagen para resolver. La IA proporcionará automáticamente una descripción de imagen completa Y responderá tu pregunta específica."
            }
        },
