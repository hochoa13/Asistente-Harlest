...
HONCHO_TOOL_SCHEMA = {
    ...
    "description": (
        "Consulta Honcho para recuperar contexto relevante sobre el usuario según su "
        "historial y preferencias. Usa esto cuando necesites entender el trasfondo del usuario, "
        "preferencias, interacciones pasadas u objetivos. Esto te ayuda a "
        "personalizar tus respuestas y proporcionar asistencia más relevante."
    ),
    "parameters": {
        "type": "object",
        "properties": {
            "query": {
                "type": "string",
                "description": (
                    "Una pregunta en lenguaje natural sobre el usuario. Ejemplos: "
                    ...
                    "'¿Cuál es el nivel de experiencia técnica de este usuario?'"
                ),
            }
        },
        "required": ["query"],
