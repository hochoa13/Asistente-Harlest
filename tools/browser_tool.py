...
BROWSER_TOOL_SCHEMAS = [
    {
        ...
        "description": "Navega a una URL en el navegador. Inicializa la sesión y carga la página. Debe ser llamado antes que otras herramientas del navegador. Para recuperación simple de información, prefiere web_search o web_extract (más rápido, más barato). Usa herramientas de navegador cuando necesites interactuar con una página (hacer clic, rellenar formularios, contenido dinámico).",
        "parameters": {
            "type": "object",
            "properties": {
                "url": {
                    "type": "string",
                    "description": "La URL a la que navegar (p. ej., 'https://example.com')"
                }
            },
            "required": ["url"]
        }
    },
    {
        ...
        "description": "Obtiene una instantánea basada en texto del árbol de accesibilidad de la página actual. Devuelve elementos interactivos con IDs de referencia (como @e1, @e2) para browser_click y browser_type. full=false (predeterminado): vista compacta con elementos interactivos. full=true: contenido de página completo. Las instantáneas con más de 8000 caracteres se truncan o se resumen con IA. Requiere que browser_navigate se haya llamado primero.",
        "parameters": {
            "type": "object",
            "properties": {
                "full": {
                    "type": "boolean",
                    "description": "Si es verdadero, devuelve contenido de página completo. Si es falso (predeterminado), devuelve vista compacta solo con elementos interactivos.",
                    "default": False
                }
            },
            "required": []
    ...
    {
        "name": "browser_click",
        "description": "Haz clic en un elemento identificado por su ID de referencia de la instantánea (p. ej., '@e5'). Los IDs de referencia se muestran entre corchetes en la salida de instantánea. Requiere que browser_navigate y browser_snapshot se hayan llamado primero.",
        "parameters": {
            "type": "object",
            "properties": {
                "ref": {
                    "type": "string",
                    "description": "La referencia del elemento de la instantánea (p. ej., '@e5', '@e12')"
                }
            },
            "required": ["ref"]
        }
    ...
    {
        "name": "browser_type",
        "description": "Escribe texto en un campo de entrada identificado por su ID de referencia. Limpia el campo primero, luego escribe el texto nuevo. Requiere que browser_navigate y browser_snapshot se hayan llamado primero.",
        "parameters": {
            "type": "object",
            "properties": {
                "ref": {
                    "type": "string",
                    "description": "La referencia del elemento de la instantánea (p. ej., '@e3')"
                },
                "text": {
                    "type": "string",
    ...
    {
        "name": "browser_scroll",
        "description": "Desplaza la página en una dirección. Usa esto para revelar más contenido que puede estar debajo o encima de la ventana gráfica actual. Requiere que browser_navigate se haya llamado primero.",
        "parameters": {
            "type": "object",
            "properties": {
                "direction": {
                    "type": "string",
                    "enum": ["up", "down"],
                    "description": "Dirección a desplazarse"
                }
            },
            "required": ["direction"]
        }
    ...
    {
        "name": "browser_back",
        "description": "Navega hacia atrás a la página anterior en el historial del navegador. Requiere que browser_navigate se haya llamado primero.",
        "parameters": {
            "type": "object",
            "properties": {},
            "required": []
    ...
    {
        "name": "browser_press",
        "description": "Presiona una tecla del teclado. Útesil para enviar formularios (Enter), navegar (Tab), o accesos rápidos de teclado. Requiere que browser_navigate se haya llamado primero.",
        "parameters": {
            "type": "object",
            "properties": {
                "key": {
                    "type": "string",
                    "description": "Tecla a presionar (p. ej., 'Enter', 'Tab', 'Escape', 'ArrowDown')"
                }
            },
            "required": ["key"]
        }
    ...
    {
        "name": "browser_close",
        "description": "Cierra la sesión del navegador y libera recursos. Llama esto cuando termines con tareas del navegador para liberar cuota de sesión de Browserbase.",
        "parameters": {
            "type": "object",
            "properties": {},
            "required": []
    ...
    },
    {
        ...
        "description": "Obtiene una lista de todas las imágenes en la página actual con sus URLs y texto alternativo. Útesil para encontrar imágenes para analizar con la herramienta de visión. Requiere que browser_navigate se haya llamado primero.",
        "parameters": {
            "type": "object",
            "properties": {},
            "required": []
    ...
    {
        "name": "browser_vision",
        "description": "Toma una captura de pantalla de la página actual y análiza con IA de visión. Usa esto cuando necesites entender visualmente qué hay en la página - especialmente útil para CAPTCHA, desafíos de verificación visual, diseños complejos, o cuando la instantánea de texto no captura información visual importante. Devuelve tanto el análisis de IA como una screenshot_path que puedes compartir con el usuario incluyendo MEDIA:<screenshot_path> en tu respuesta. Requiere que browser_navigate se haya llamado primero.",
        "parameters": {
            "type": "object",
            "properties": {
                "question": {
                    "type": "string",
                    "description": "Qué quieres saber sobre la página visualmente. Sé específico sobre lo que estás buscando."
                },
                "annotate": {
                    "type": "boolean",
                    "default": False,
                    "description": "Si es verdadero, superpone etiquetas numeradas [N] en elementos interactivos. Cada [N] se asigna a ref @eN para comandos posteriores del navegador. Útesil para QA y razonamiento espacial sobre el diseño de la página."
                }
            },
            "required": ["question"]
        }
    },
    {
        ...
        "description": "Obtiene salida de consola del navegador y errores de JavaScript de la página actual. Devuelve mensajes console.log/warn/error/info y excepciones de JavaScript no capturadas. Usa esto para detectar errores de JavaScript silenciosos, llamadas API fallidas, y advertencias de aplicación. Requiere que browser_navigate se haya llamado primero.",
        "parameters": {
            "type": "object",
            "properties": {
                "clear": {
                    "type": "boolean",
                    "default": False,
                    "description": "Si es verdadero, limpia los búferes de mensaje después de leer"
                }
            },
            "required": []
        }
