...
If your skill is specialized, community-contributed, or niche, it's better suited for a **Skills Hub** — upload it to a skills registry and share it in the [Harlest Community](#). Users can install it with `hermes skills install`.
...
├── tests/                    # Test suite
├── website/                  # Documentation site (Asistente-Harlest)
│
...
- Use [GitHub Issues](https://github.com/hochoa13/Asistente-Harlest/issues)
