...
def resolve_requested_provider(requested: Optional[str] = None) -> str:
    """Resolver el proveedor a partir del argumento explícito, luego env y después config."""
...
def resolve_runtime_provider(
    *,
    ...
    """Resolver las credenciales del proveedor de inferencia en tiempo de ejecución para la ejecución del agente."""
