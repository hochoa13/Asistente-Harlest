...
from agent.prompt_builder import (
    DEFAULT_AGENT_IDENTITY, RANSOMWARE_PENTESTING_IDENTITY, PLATFORM_HINTS,
...
class AIAgent:
    ...
    def __init__(
        ...
        agent_specialty: str = "default",
    ):
        """
        Initialize the AI Agent.

        Args:
            agent_specialty (str): Especialización del agente: "default" o "ransomware_pentesting".
                Por defecto "default" es un asistente general. "ransomware_pentesting" es especialista
                en seguridad ofensiva, análisis de malware y penetration testing (default: "default")
        Initialize the AI Agent.
        ...
        self.agent_specialty = agent_specialty.lower() if agent_specialty else "default"
    ...
    def _build_system_prompt(self, system_message: str = None) -> str:
        ...
        prompt_parts = [DEFAULT_AGENT_IDENTITY if self.agent_specialty == "default" else RANSOMWARE_PENTESTING_IDENTITY]
        ...
        while api_call_count < self.max_iterations and self.iteration_budget.remaining > 0:
            ...
            while retry_count < max_retries:
                try:
                    ...
                    # Verificar errores de longitud de contexto ANTES del manejador genérico 4xx.
                    # Los backends locales (LM Studio, Ollama, llama.cpp) a menudo devuelven
                    # HTTP 400 con mensajes como "Context size has been exceeded"
                    # que deben activar compresión, no una interrupción inmediata.
